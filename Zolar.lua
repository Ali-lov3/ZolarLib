...
local Library = { } do
 ...
 local IsMove = Input.UserInputType == Enum.UserInputType.MouseMovement
 local IsTouch = 
…[truncated]Input.UserInputType == Enum.UserInputType.Touch
 ...
 Picker:Set(Default or Library.Theme.Accent
…[truncated], Picker.Transparency)
 return Picker
 end
 ...
 MakeAccentShadow(MobileToggle.Instance, 2, 8, 0.35)

 Library:Create("UIStroke", {
 Parent = MobileToggle.Instance,
 Color = Library.Theme.AccentDark,
 Thickness = 1
 }):AddToTheme({ Color = "AccentDark" })
